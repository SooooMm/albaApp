...
public class Setting {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// CRUD U update //2개의 쿼리를 동시에 돌리기 위해 con 2개 (1개는 select, 1개는 update)
			var con2 = DriverManager.getConnection("jdbc:mysql://localhost/2022지방_2?serverTimezone=UTC&allowLoadLocalInfile=true", "root", DB_PWD);
			...
			//사용자 생성 (DCL)
			stmt.execute("DROP USER IF EXISTS 'user'@'localhost'"); //root 아니라 user 사용해서 권한제한
